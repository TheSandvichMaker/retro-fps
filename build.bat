...
rem "release" for now is actually a "development" build, just with optimizations
...
set debug_flags=/Od /MTd /DDREAM_DEVELOPMENT=1 /DDREAM_SLOW=1
set release_flags=/O2 /MT /DDREAM_DEVELOPMENT=1
