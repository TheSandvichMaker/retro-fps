...
fn void shader_set_params__brush_draw_parameters_t(rhi_command_list_t *list, uint32_t slot, brush_draw_parameters_t *parameters);
...
fn void shader_set_params__brush_pass_parameters_t(rhi_command_list_t *list, uint32_t slot, brush_pass_parameters_t *parameters);
