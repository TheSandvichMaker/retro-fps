...
void shader_brush_metashader_set_draw_params(rhi_command_list_t *list, brush_metashader_draw_parameters_t *params)
{
	rhi_validate_texture_srv(params->albedo, S("shader_brush_metashader_set_draw_params"));
	rhi_validate_texture_srv(params->lightmap, S("shader_brush_metashader_set_draw_params"));
	rhi_set_parameters(list, 0, params, sizeof(*params));
}

void shader_brush_metashader_set_pass_params(rhi_command_list_t *list, brush_metashader_pass_parameters_t *params)
{
	rhi_validate_buffer_srv(params->lm_uvs, S("shader_brush_metashader_set_pass_params"));
	rhi_validate_buffer_srv(params->position, S("shader_brush_metashader_set_pass_params"));
	rhi_validate_texture_srv(params->sun_shadowmap, S("shader_brush_metashader_set_pass_params"));
	rhi_validate_buffer_srv(params->uvs, S("shader_brush_metashader_set_pass_params"));
	rhi_set_parameters(list, 1, params, sizeof(*params));
}

#define DF_SHADER_BRUSH_METASHADER_SOURCE_CODE \
	"// Generated by metagen.lua\n" \
	"\n" \
